...
export const metadata = {
  title: "Brothers' Unit - Celestial Church of Christ",
  description: "Brothers' Unit - Coming Soon",
}

export default function BrothersUnitPage() {
  return (
          ...
          <div className="mb-12">
            <svg className="w-full max-w-md mx-auto h-48" viewBox="0 0 300 200" xmlns="http://www.w3.org/2000/svg">
              ...
              <rect
                ...
                strokeDasharray="5,5"
              />
              <line x1="150" y1="40" x2="150" y2="80" stroke="url(#craneGrad)" strokeWidth="8" />
              <line x1="150" y1="50" x2="100" y2="20" stroke="url(#craneGrad)" strokeWidth="6" />
              <line x1="150" y1="50" x2="200" y2="20" stroke="url(#craneGrad)" strokeWidth="6" />
