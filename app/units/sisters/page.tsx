...
export const metadata = {
  title: "Sisters' Unit - Celestial Church of Christ",
  description: "Sisters' Unit - Coming Soon",
}

export default function SistersUnitPage() {
  return (
        ...
        <div className="text-center max-w-2xl">
          ...
          <div className="mb-12">
            <svg className="w-full max-w-md mx-auto h-48" viewBox="0 0 300 200" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="craneGrad2" x1="0%" y1="0%" x2="100%" y2="0%">
              ...
              <rect
                ...
                strokeDasharray="5,5"
              />
              <line x1="150" y1="40" x2="150" y2="80" stroke="url(#craneGrad2)" strokeWidth="8" />
              <line x1="150" y1="50" x2="100" y2="20" stroke="url(#craneGrad2)" strokeWidth="6" />
              <line x1="150" y1="50" x2="200" y2="20" stroke="url(#craneGrad2)" strokeWidth="6" />
